...
public class Main extends Application {
    ...
    // public void readSubsMonths() {
    // try {
    // String readLine = "";
    // FileReader reader = new
    // FileReader("src\\main\\resources\\Files\\subscriptionmonths.txt");
    // int c;
    ...
    // Subscription.monthlyRevenue[commaCounter] = rev;
    // commaCounter++;
    ...
    public void writeSubsMonths() {
        try {
            FileWriter writer = new FileWriter("src\\main\\resources\\Files\\subscriptionmonths.txt");
            for (int rev : Subscription.monthlyRevenue) {
                writer.write(rev + ",");
            }
            writer.close();
    ...
    public void start(Stage stage) throws IOException {
        ...
        for (User u : userData) {
            Subscription.monthlyRevenue[u.subscription.plan.StartDate
                    .get(Calendar.MONTH)] += u.subscription.PriceOfPlan;
            System.out.println(u.getFirst_name() + " " + u.getLast_name() + " | ");
            u.subscription.CalculateTime(Calendar.getInstance());
        }

        if (CurrentUser instanceof Admin) {
            System.out.println("Month with most revenue: " + ((Admin) CurrentUser).getMostRevMonth());
            System.out.println("Plan with most subscribers: " + ((Admin) CurrentUser).getMostSubbedPlan());
